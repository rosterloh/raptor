...
- [What is raptor?](./intro/what-is-raptor.md)
- [Quick Start](./intro/quick-start.md)
- [hawkBit Compatibility](./intro/compatibility.md)
...
- [Targets & Auto-Registration](./guides/targets.md)
- [Software Modules & Artifacts](./guides/modules-artifacts.md)
- [Distribution Sets](./guides/distribution-sets.md)
...
- [Update Lifecycle](./concepts/update-lifecycle.md)

# Reference

- [Configuration](./reference/configuration.md)
- [Management API](./reference/management-api.md)
- [DDI API](./reference/ddi-api.md)
